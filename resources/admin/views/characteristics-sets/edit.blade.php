<x-app-layout>
    <x-slot name="header">
        Создание Характеристики Группа "{{$characteristics_set->name}}"
    </x-slot>
    ...
    <div class="px-4 py-3 mb-8 bg-white rounded-lg shadow-md dark:bg-gray-800">
        ...
        <form method="POST" action="{{ route('admin.characteristics-sets.update', $characteristics_set) }}" enctype="multipart/form-data">
            @csrf
            @method('PUT')

            @include('characteristics-sets.form')
        </form>
    </div>
</x-app-layout>
