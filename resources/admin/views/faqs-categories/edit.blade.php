<x-app-layout>
    <x-slot name="header">
        Изменение FAQ Категории "{{$faqs_category->name}}"
    </x-slot>
    ...
    <div class="px-4 py-3 mb-8 bg-white rounded-lg shadow-md dark:bg-gray-800">
        ...
        <form method="POST" action="{{ route('admin.faqs-categories.update', $faqs_category) }}" enctype="multipart/form-data">
            @csrf
            @method('PUT')

            @include('faqs-categories.form')
        </form>
    </div>
</x-app-layout>
