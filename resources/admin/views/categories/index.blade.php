        ...
        <div class="w-full overflow-x-auto">
            <table class="w-full whitespace-no-wrap">
                ...
                <tr class="text-xs font-semibold tracking-wide text-left text-gray-500 uppercase border-b dark:border-gray-700 bg-gray-50 dark:text-gray-400 dark:bg-gray-800">
                    ...
                    <th class="px-4 py-3">Кол-во товара</th>
                ...
                @foreach($categories as $category)
                    <tr class="text-gray-700 dark:text-gray-400">
                        ...
                        <td class="px-4 py-3">
                            <a href="{{ $category->imagePath }}" target="_blank">
                                <img src="{{ $category->imagePath }}" alt="" style="height: 100px; width: 100px; object-fit: contain">
                            </a>
                        </td>
                        <td class="px-4 py-3">
                        ...
                        <td class="px-4 py-3">
                            <div class="flex items-center text-sm">
                                <a href="{{ route('admin.categories.edit', $category) }}" class="flex items-center justify-between px-2 py-2 text-sm font-medium leading-5 text-purple-600 rounded-lg dark:text-gray-400 focus:outline-none focus:shadow-outline-gray">
