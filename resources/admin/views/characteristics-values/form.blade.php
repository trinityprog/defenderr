<div>
    ...
    <input type="text" id="name_en" name="name[en]" value="{{ isset($characteristics_value->name) ? $characteristics_value->getTranslation('name', 'en') : old('name.en') }}" required
...
<div class="mt-4">
    ...
    <input type="text" id="name_ru" name="name[ru]" value="{{ isset($characteristics_value->name) ? $characteristics_value->getTranslation('name', 'ru') : old('name.ru') }}" required
           class="block w-full mt-1 border-gray-300 rounded-md shadow-sm focus:border-primary-300 focus:ring focus:ring-primary-200 focus:ring-opacity-50 focus-within:text-primary-600
