<x-app-layout>
    <x-slot name="header">
        Изменение Цвета "{{$products_color->name}}"
    </x-slot>
    ...
    <div class="px-4 py-3 mb-8 bg-white rounded-lg shadow-md dark:bg-gray-800">
        ...
        <form method="POST" action="{{ route('admin.products-colors.update', $products_color) }}" enctype="multipart/form-data">
            @csrf
            @method('PUT')

            @include('products-colors.form')
        </form>
    </div>
</x-app-layout>
